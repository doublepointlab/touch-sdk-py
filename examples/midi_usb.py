...
# Handle USB MIDI device interaction
def handle_usb_midi_device():
    output_names = [name for name in mido.get_output_names() if name != "Network mb1"]
    if output_names:
        print("USB MIDI devices detected:")
        ...
        with mido.open_output(selected_device) as output:
            while True:
        ...
        print("No USB MIDI devices detected besides 'Network mb1'.")
